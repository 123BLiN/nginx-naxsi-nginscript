...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
        ...
        && curl -fSL http://hg.nginx.org/njs/archive/$NGINSCRIPT_VERSION.tar.gz -o njs.tar.gz \
        ...
        && install -m644 /usr/src/naxsi-$NAXSI_VERSION/naxsi_config/naxsi_core.rules /etc/nginx \
